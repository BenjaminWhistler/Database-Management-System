...
{
    public partial class AlumniMainForm : Form
    {
        public static AlumniMainForm Instance;
        ...
        private void AlumniMainForm_Load(object sender, EventArgs e)
        {
        ...
        {
            AlumniMainForm.restrictAdd = false;
            AlumniMainForm.restrictEdit = false;
            AlumniMainForm.restrictFilter = false;
            AlumniMainForm.restrictView = false;
        }
        ...
        private void deleteARecordToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
              ...
              //      this.alumniTableAdapter.DeleteSubRecords(m_id);
